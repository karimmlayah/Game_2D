...
# 53 "fonction.h" 2
# 1 "/usr/include/SDL/SDL_ttf.h" 1 3 4
# 31 "/usr/include/SDL/SDL_ttf.h" 3 4
# 1 "/usr/include/SDL/begin_code.h" 1 3 4
# 32 "/usr/include/SDL/SDL_ttf.h" 2 3 4
# 64 "/usr/include/SDL/SDL_ttf.h" 3 4
extern __attribute__ ((visibility("default"))) const SDL_version * TTF_Linked_Version(void);
# 74 "/usr/include/SDL/SDL_ttf.h" 3 4
...
# 174 "/usr/include/SDL/SDL_ttf.h" 3 4
...
# 196 "/usr/include/SDL/SDL_ttf.h" 3 4
...
extern __attribute__ ((visibility("default"))) SDL_Surface * TTF_RenderGlyph_Blended(TTF_Font *font,
      Uint16 ch, SDL_Color fg);
# 228 "/usr/include/SDL/SDL_ttf.h" 3 4
...
# 247 "/usr/include/SDL/SDL_ttf.h" 3 4
# 1 "/usr/include/SDL/close_code.h" 1 3 4
# 248 "/usr/include/SDL/SDL_ttf.h" 2 3 4
# 54 "fonction.h" 2
...
void afficherTemps(time_t *timeingame, SDL_Surface *screen);
void afficherminimap(minimap m, SDL_Surface *screen);

void MAJMinimap(SDL_Rect posJoueur, minimap *m, SDL_Rect camera, int redimensionnement);
SDL_Color GetPixel(SDL_Surface *pSurface, int x, int y);
int collisionPP(SDL_Rect p, SDL_Surface *Masque);
void clean(time_t *timeingame, minimap *m);
# 4 "fonctions.c" 2
...
void initminimap(minimap *m)
{
    ...
    {
        m->animation.Clips[i].w = 100;
        m->animation.Clips[i].h = 500;
